...
import com.cyberdetox.amaravathijuniorcollege.adapters.StudentConsolidateDetailsAdapter;
...
import com.cyberdetox.amaravathijuniorcollege.adapters.StudentExamResultAdapter;
import com.cyberdetox.amaravathijuniorcollege.adapters.StudentExamResultGpaAdapter;
                            ...
                            if(exam.getString("exam_type").equals("gpa")){
                              ...
                              //  percentageTV.setText(exam.getString("exam_credit_hour"));
                                ...
                                if(status.toLowerCase().equals("pass")) {
                                    ...
                                    statusTV.setText(getApplicationContext().getString(R.string.pass));
                                } else {
                                    statusTV.setBackgroundResource(R.drawable.red_border);
                                    statusTV.setText(getApplicationContext().getString(R.string.fail));
                                }
