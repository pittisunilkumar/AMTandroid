...
import com.cyberdetox.amaravathijuniorcollege.adapters.StudentQuestionsListAdapter;
...
public class StudentOnlineExamQuestionsNew extends AppCompatActivity {
   ...
   File f;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSelectImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    Log.e("Else", "Else");
                    ActivityCompat.requestPermissions(StudentOnlineExamQuestionsNew.this, permissions(), 1);
                    showFileChooser();
    ...
    private String getFilename(Context context) {
        ...
        String mImageName=filename+"."+extension;
            ...
            client.newCall(request).enqueue(new Callback() {
                ...
                public void onFailure(Call call, IOException e) {
                    runOnUiThread(new Runnable() {
                        public void run() {
                            final Toast toast = Toast.makeText(StudentOnlineExamQuestionsNew.this, R.string.apiErrorMsg, Toast.LENGTH_SHORT);
                            toast.show();
                        }
                    });
                }
