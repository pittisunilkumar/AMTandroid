...
import com.cyberdetox.amaravathijuniorcollege.AboutSchool;
import com.cyberdetox.amaravathijuniorcollege.Login;
import com.cyberdetox.amaravathijuniorcollege.R;
import com.cyberdetox.amaravathijuniorcollege.SettingActivity;
import com.cyberdetox.amaravathijuniorcollege.TakeUrl;
import com.cyberdetox.amaravathijuniorcollege.adapters.AcademicModuleAdapter;
import com.cyberdetox.amaravathijuniorcollege.adapters.CommunicateModuleAdapter;
import com.cyberdetox.amaravathijuniorcollege.adapters.ElearningModuleAdapter;
import com.cyberdetox.amaravathijuniorcollege.adapters.LoginChildListAdapter;
import com.cyberdetox.amaravathijuniorcollege.adapters.OtherModuleAdapter;
import com.cyberdetox.amaravathijuniorcollege.model.Album1;
import com.cyberdetox.amaravathijuniorcollege.utils.Constants;
import com.cyberdetox.amaravathijuniorcollege.utils.DatabaseHelper;
import com.cyberdetox.amaravathijuniorcollege.utils.DrawerArrowDrawable;
import com.cyberdetox.amaravathijuniorcollege.utils.Utility;
...
public class NewDashboard extends AppCompatActivity {
    ...
    private void getElearningFromApi (String bodyParams) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                makeText(NewDashboard.this, R.string.apiErrorMsg, Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
    ...
    private void decorate() {
        ...
        admissionno.setText("Application No. "+Utility.getSharedPreferences(this, Constants.admission_no));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String result) {
                if (result != null) {
                    ...
                    pd.dismiss();
                    makeText(NewDashboard.this, R.string.noInternetMsg, Toast.LENGTH_SHORT).show();
                }
            }
        },new Response.ErrorListener() {
            @Override
    ...
    private void getDataFromApi (String bodyParams) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Log.e("Volley Error", volleyError.toString());
                makeText(getApplicationContext(), R.string.apiErrorMsg, Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
            public Map<String, String> getHeaders() throws AuthFailureError {
