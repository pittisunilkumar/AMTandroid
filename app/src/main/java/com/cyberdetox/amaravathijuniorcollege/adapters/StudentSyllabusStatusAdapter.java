...
public class StudentSyllabusStatusAdapter extends RecyclerView.Adapter<StudentSyllabusStatusAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        if (totalList.get(position).equals("0")) {
            holder.status.setText(totalList.get(position)+"% "+context.getApplicationContext().getString(R.string.completed));
        }else {
            ...
            holder.status.setText(String.valueOf(Math.round(complete_per)) +"% "+context.getApplicationContext().getString(R.string.completed));
        }
