...
public class StudentOnlineExamResultAdapter extends RecyclerView.Adapter<StudentOnlineExamResultAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.subject.setText(context.getApplicationContext().getString(R.string.subject)+":  "+subject_namelist.get(position));
        ...
        if(is_neg_marking_marks.equals("1")){
            ...
            holder.neg_marks.setText("("+context.getApplicationContext().getString(R.string.negative)+": "+neg_marks_list.get(position)+")");
        }else{
        ...
        if(question_typelist.get(position).equals("multichoice")){
            ...
            if(select_optionlist.get(position).equals(correctlist.get(position))){
                holder.marks.setText("("+context.getApplicationContext().getString(R.string.marks)+": 1.00/"+marklist.get(position)+")");
            }else{
                holder.marks.setText("("+context.getApplicationContext().getString(R.string.marks)+": 0.00/"+marklist.get(position)+")");
            }
